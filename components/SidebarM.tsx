...
export function SidebarM({ isOpen }: SidebarProps) {
  ...
  const menuSections = [
    {
      title: 'PRINCIPAL',
      items: [
        { icon: Home, label: 'Tableau de bord', href: '/dashboardm' },
        { icon: Users, label: 'Collaborateurs', href: '/dashboardm/collaborateur', badge: collabTotal },
        { icon: Shield, label: 'Rôles', href: '/dashboardm/role'},
        { icon: Users, label: 'RH', href: '/dashboardm/RH' },
      ],
    },
    {
      title: 'GESTION',
      items: [
        //{ icon: Calendar, label: 'Calendrier', href: '/dashboardm/calendrier' },
        { icon: Mail, label: 'Messages', href: '/dashboardm/messages' },
        { icon: ClipboardList, label: 'Onboarding', href: '/dashboardm/onboarding' },
        { icon: ClipboardList, label: 'Mes Suivis', href: '/dashboardm/suivis' },
      ],
    },
    {
      title: 'SYSTÈME',
      items: [
        { icon: UserCircle, label: 'Mon profil', href: '/dashboardm/Profil' },
      ],
    },
  ];
